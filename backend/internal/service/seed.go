...
func (s *SeedService) Seed() error {
	...
	users := []model.User{
		...
		{Phone: "13800000002", PasswordHash: string(adminHash), Name: "王安全", Role: constants.RoleSafetyManager},
		{Phone: "13800000003", PasswordHash: string(adminHash), Name: "李监理", Role: constants.RoleInspector},
		{Phone: "13800000004", PasswordHash: string(adminHash), Name: "赵工", Role: constants.RoleWorker},
	}
	for i := range users {
